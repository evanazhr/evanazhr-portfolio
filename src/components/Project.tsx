  ...
  const projectItems = [
    {
      ...
      description:
        "Aplikasi kasir yang dibuat dengan NextJs, Typescript, memiliki fitur auth dari Clerk, payment gateway dari xendit, dll. ",
    ...
    },
    {
      ...
      description: "Slicing Landing Page Collosal dari codedesign.dev",
      thumbnail: "/assets/thumbnails/collosal.png",
      link: "https://collosal-landing-page-three.vercel.app/",
      repo: "https://github.com/evanazhr/collosal-landing-page.git",
      tech: ["Next.Js", "React.Js", "Typescript", "Tailwind"],
    },

    {
      title: "Suxz Landing Page",
      description: "belajar slicing UI Suxz dari codedesign.dev",
      thumbnail: "/assets/thumbnails/suxz.png",
    ...
    },
    {
      ...
      description: "Aplikasi Chatting realtime dengam websocket API",
      thumbnail: "/assets/image/gradient.png",
      link: "",
    ...
    <div className=" w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-4">
      {projectItems.map((item, index) => (
        <ScaleUp key={index} delay={index}>
          <SpotlightCard
            className="custom-spotlight-card flex flex-col rounded-xl min-h-full"
            spotlightColor="rgba(0, 229, 255, 0.2)"
          >
            <Card className="overflow-hidden  pt-0 justify-between shadow-lg transition-all duration-300 ease-in-out flex-grow">
              <CardHeader className="px-0">
                ...
                <CardTitle className="px-6 mt-5">{item.title}</CardTitle>
                ...
                <div className="flex text-md flex-row gap-2 justify-center items-center">
                  {item.link !== "" ? (
                    <a
                      ...
                      className="border border-primary  text-primary p-2 rounded-full decoration-none  hover:bg-primary hover:text-background flex gap-2 justify-center items-center hover:underline active:underline"
                    >
                  ...
                  {item.repo !== "" ? (
                    <a
                      ...
                      href={item.repo}
                      rel="noopener noreferrer"
                      className="border border-primary text-primary p-2 rounded-full hover:bg-primary hover:text-background flex gap-2 justify-center items-center hover:underline active:underline"
                    >
